...
{
	cout << "ConcurrentSkipList Number of comparison = " << n_cmp_read << endl;
	cout << "ConcurrentSkipList Number of pointer refs = "<< n_ptr_ref << endl;
	cout << "ConcurrentSkipList Number of CAS update = " << n_cas << endl;
	cout << "ConcurrentSkipList Number of CAS fail = " << n_cas_fail << endl; 
}
